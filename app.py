...
async def predictRouteClient(request: Request):
    try:
        ...
        # Friendly prediction result
        status = (
            "✅ Great news! This customer is likely to purchase vehicle insurance." 
            if value == 1 
            else "⚠️ Unfortunately, this customer is unlikely to purchase vehicle insurance."
        )
